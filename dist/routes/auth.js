...
router.get('/github/callback', async (req, res) => {
    const { code, state, code_verifier, source } = req.query;
    if (!code) {
    ...
    try {
        ...
        const tokenRes = await axios.post('https://github.com/login/oauth/access_token', tokenParams, { headers: { Accept: 'application/json' } });
